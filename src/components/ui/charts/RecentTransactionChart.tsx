        ...
        >
            <Card className="bg-white dark:bg-gray-800 shadow-lg transition-colors duration-200">
                <CardHeader className="flex flex-row items-center justify-between">
                    <CardTitle className="text-lg font-semibold text-gray-900 dark:text-gray-100">Últimas Transações</CardTitle>
                    <Popover>
                        <PopoverTrigger>
                        ...
                        <PopoverContent className="bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100">
                            Este gráfico de barras exibe suas transações mais recentes, permitindo uma rápida comparação entre
